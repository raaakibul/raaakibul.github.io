...
const resources = [
  {
    ...
    category: "datasets",
    description:
      "Large visual database designed for use in visual object recognition research.",
    ...
    content: `
                    ...
                    <h3>Key Features</h3>
                    <ul>
                        <li>Over 14 million images</li>
                        <li>20,000 categories with at least 500 images</li>
                        <li>1.2 million images with bounding boxes</li>
                        <li>Standard benchmark for image classification</li>
                    </ul>
                    <h3>Usage</h3>
                    <p>ImageNet is widely used for training deep learning models, especially convolutional neural networks (CNNs). The ImageNet Large Scale Visual Recognition Challenge (ILSVRC) has been instrumental in advancing computer vision research.</p>
                    <p>ImageNet is widely used for training deep learning models, especially convolutional neural networks (CNNs). The ImageNet Large Scale Visual Recognition Challenge (ILSVRC) has been instrumental in advancing computer vision research.</p>
                    
                    <p>To use ImageNet, you need to register on their official website and agree to their terms of use. The dataset is available for non-commercial research purposes.</p>
                    <p>To use ImageNet, you need to register on their official website and agree to their terms of use. The dataset is available for non-commercial research purposes.</p>
                    <p>To use ImageNet, you need to register on their official website and agree to their terms of use. The dataset is available for non-commercial research purposes.</p>
                `,
  },
